(function() {
    // --- 1. CONFIGURATION SUPABASE ISOLÉE ---
...
const SUPABASE_ANON_KEY = "sb_publishable_2-Ij-nrTPeK6rB-kSD-QTg_b42zNakq";
    ...
    const clientAuth = window.supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY);
    ...
    // --- 3. ENREGISTREMENT SÉCURISÉ (Rendu accessible globalement pour le HTML) ---
    window.envoyerDemandeAcces = async function() {
